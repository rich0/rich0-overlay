...
SRC_URI="https://github.com/raduprv/Eternal-Lands/archive/${PV}.tar.gz -> eternal-lands-${PV}.tar.gz
...
RDEPEND="dev-libs/libxml2:=
	...
	media-libs/sdl-net:=
	>=games-rpg/eternal-lands-data-${PV}
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-1.9.4-glbuild.patch"
	epatch "${FILESDIR}/${PN}-1.9.4-makefile.patch"
	epatch "${FILESDIR}/${PN}-1.9.4-defaults.patch"
